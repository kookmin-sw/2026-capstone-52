  ...
  os: {
    ...
    concepts: [
      ...
      },
      {
        ...
        relatedKeys: ["cfs", "fairness"],
        keywords: ["vruntime", "weight", "nice", "niceness"],
      },
      {
        key: "fairness",
        label: "공정성 균형",
        description: "Lottery, Stride, CFS를 비교할 때 확률성, 결정성, 실제 시스템의 성능 균형을 함께 보는 정리 관점입니다.",
